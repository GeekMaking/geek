$(function(){
    ...
    $.ajax({
        type: "get",
        url: "/yuan/management/findAllUser.action",
                    ...
                    if(userName!=""&&password!=""){
                        if(userName==$(this).children("td:eq(1)").text()) {
                            ...
                            //交互
                                $.ajax({
                                type: "POST",
                                url: "/yuan/management/addUser.action",
                                data:{
                                    password: password,
                                    userName: userName
                                },
    ...
    $(".del").click(function() {
            ...
            if(i==0){
                        ...
                        if(chk.attr("id")!="checkall"){//不能删除标题行
                            if(chk.attr("checked")){
                                ...
                                if(deleteUserName!=""){
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "/yuan/management/deleteUser.action",
                                        data:{
                ...
                if(co){
                   ...
                   $.ajax({
                        type: "POST",
                        url: "/yuan/management/deleteUsers.action",
                        data:{
             ...
             $(".savechange").click(function(){
                 ...
                 if(!regPassword.test(updataPassword)){
                    alert("密码必须是6-12位英文数字特殊字符！");
                        ...
                        $.ajax({
                         type: "POST",
                         url: "/yuan/management/updateUser.action",
                         data:{
